...
export default function Form({ stepPhase }) {
  return (
    <section className={`${styles['form-container']} col col-lg-12 col-sm-12`}>
      {stepPhase === 1 && <form className='col col-12' data-phase='address'>
      ...
      {stepPhase === 2 && <form className='col col-12' data-phase='shipping'>
      ...
      {stepPhase === 3 && <form className='col col-12' data-phase='credit-card'>
